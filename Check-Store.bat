...
rem NOTE: the $paths/$names arrays below mirror $Stores in Fix-AudioMixer.ps1 and the
rem table in README.md - change one, change all three. The loop is driven by
rem $paths.Count, so adding a variant here needs no other edit in this file.
